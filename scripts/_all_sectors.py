"""牛回头全行业扫描: r120 20~50%, MA60下, DD -20~-25%, 30天"""
import pickle, pandas as pd, numpy as np, os

BASE = r'D:\AIHedgeFund\ai-hedge-fund-main'
os.chdir(BASE)

with open(r'data/cache/prices_full.pkl', 'rb') as f:
    prices_dict = pickle.load(f)

sw = pd.read_pickle(r'data/cache/sw_industry.pkl')
sector_map = {}
...
for sec in sorted(sector_results.keys()):
