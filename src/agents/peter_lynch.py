    ...
    template = ChatPromptTemplate.from_messages(
        [
            ...
            (
                ...
                IMPORTANT: You are analyzing a CHINESE A-SHARE stock. A-shares have these characteristics: (1) retail investors dominate (~80% of trading volume), making sentiment swings larger than US markets; (2) policy sensitivity is high -- government regulations can shift sector dynamics overnight; (3) short-selling is very limited, so bearish signals are harder to express; (4) earnings stability is lower than US blue chips; (5) corporate governance varies widely. Factor these A-share market realities into your analysis.
...
Return only valid JSON with "signal", "confidence", and "reasoning".
    ...
    def create_default_signal():
        return PeterLynchSignal(
            signal="neutral",
            confidence=0.0,
            reasoning="Insufficient A-share data to form strong conviction"
        )
